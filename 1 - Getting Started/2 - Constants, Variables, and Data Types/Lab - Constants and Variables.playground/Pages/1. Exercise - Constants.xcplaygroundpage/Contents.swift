...
//friends -= 45
print("1. Exercise - Constants.xcplaygroundpage:10:7: error: unterminated string literal")
...
print("This code does not compile due to attempting to modify a constant")
