...
var vlad = User(name: "vlad", age: 20, height: 140, weight: 240, activityLevel: 10)
print(vlad.name, vlad.age, vlad.height, vlad.weight, vlad.activityLevel)
...
var otherMile = Distance(feet: 5249.344)
print(otherMile.meters)
/*:
